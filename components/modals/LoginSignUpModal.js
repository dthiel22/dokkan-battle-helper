        ...
        <div className="flex flex-col pt-2">
          {atLoginForm ? (
            ...
            >
              ...
              ></input>
              <p className="ml-1 mb-4 text-sm text-gray-400">* password must be eight characters long with at least one uppercase letter, one lowercase letter, one number and one special character ( '@', '$', '!', '%', '*', '?', '&', ':' or '.') *</p>
