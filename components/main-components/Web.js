...
const rightArrowIcon = "/dokkanIcons/icons/right-arrow-icon.png";
...
function Web({ webOfTeam, removeFromWebOfTeam, allCharactersLoading, selectedCharacter, handleNewDetails, addToWebOfTeam, statsSelectedOptions, showSuggestedCards, handleSetShowSuggestedCards, showMiddleDiv, showSuggestedCardsByStats, setShowSuggestedCardsByStats }) {
  ...
  }, [allCharactersLoading, showSuggestedCards, showMiddleDiv, windowWidth]);
    ...
    <ReactFlowProvider>
      ...
      <div ref={myDivRef} className={`h-full relative`}>
        ...
        <div className="h-full bg-slate-700 row-span-6 relative">
          ...
          {/* hamburger button */}
          <div className={`flex absolute ${showRemoveFromTeam ? 'top-[88px]' : 'top-[5px]'} right-[5px]`}>
              <button
