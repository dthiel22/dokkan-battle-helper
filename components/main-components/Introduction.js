...
export default function Introduction({setOpenNewsModal}) {
  return (
    <div className="flex flex-1 flex-col w-full bg-orange-200 overflow-y-auto items-center">
      <div className="pb-4">
