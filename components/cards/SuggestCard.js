...
function SuggestCard({ character, webOfTeam, selectedCharacter, handleNewDetails, addToWebOfTeam, removeFromWebOfTeam }) {
  const { levelOfLinks, grayCharactersInSelectedDeck, allCharacterIDsInDeck, statsSelectedOptions } = useContext(UserContext)
