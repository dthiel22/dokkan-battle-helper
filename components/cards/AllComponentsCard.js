...
// function AllComponentsCard({ character, webOfTeam, savedToMyCharacterDeck, userDeckData, selectedDeck, , addToWebOfTeam, newCardDetails, removeFromWebOfTeam }) {
//   const selectedDeckObj = userDeckData.find((deck) => deck._id === selectedDeck) || [];
//   const selectedDeckTeams = selectedDeckObj.teams || [];

//   if (webOfTeam) {
//     return (
//       <WebCard character={character}  webOfTeam={webOfTeam}  deckTeams={selectedDeckTeams} addToWebOfTeam={addToWebOfTeam}  removeFromWebOfTeam={removeFromWebOfTeam}  newCardDetails={newCardDetails}/>
//     );
//   } else {
//     return (
...
// const WebCard = memo(({character, webOfTeam, deckTeams, addToWebOfTeam, removeFromWebOfTeam, newCardDetails}) => {
